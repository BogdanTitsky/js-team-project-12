...
function loadHeroMarkup(movieArray) {
  ...
  const heroMarkup = `
  <div class="container hero-container" style = "background: linear-gradient(86.77deg,#111111 30.38%,rgba(17, 17, 17, 0) 65.61%), url(https://image.tmdb.org/t/p/w1280${movie.backdrop_path});">
