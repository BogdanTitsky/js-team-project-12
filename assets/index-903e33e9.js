import{a as f,b as h,c as y,f as v}from"./footer-c8cb398d.js";import{m as x}from"./card-markup-6db5ff66.js";async function M(){const o=[];for(let s=1;s<=5;s+=1){const t=`https://api.themoviedb.org/3/movie/upcoming?api_key=183c3cacc9c38c09c14d38798ccfe9d7&page=${s}`;try{const{data:n}=await f.get(t);o.push(...n.results)}catch(n){console.error(n)}}return o}async function L(e){try{return(await h()).filter(t=>e.includes(t.id)).map((t,n)=>n===0?t.name:t.name.toLowerCase()).join(", ")}catch(o){console.log(o)}}const S=document.querySelector(".js-upcoming");function $(e){return new Date(e).toLocaleString("uk",{day:"numeric",month:"numeric",year:"numeric"})}function b({backdrop_path:e,overview:o,popularity:s,release_date:t,title:n,vote_average:p,vote_count:u},g){const l=e?`https://image.tmdb.org/t/p/original/${e}`:"./img/no-image.jpg",m=o||"Sorry! No description.";return`
