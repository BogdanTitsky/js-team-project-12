import"./footer-f29026e0.js";import{a as i,m as p}from"./card-markup-4ef619ff.js";const a=document.querySelector(".js-upcoming");console.log(a);async function m(){const t="https://api.themoviedb.org/3/movie/upcoming?api_key=183c3cacc9c38c09c14d38798ccfe9d7";return await i.get(t).then(({data:e})=>(console.log(e.results),e)).catch(e=>console.error(e))}m().then(({results:t})=>{const e=new Date,c=t.filter(o=>e<Date.parse(o.release_date));if(c.length===0){console.log("No");return}const n=Math.floor(Math.random()*c.length),s=g(c[n]);_(s)});function u(t){return new Date(t).toLocaleString("uk",{day:"numeric",month:"numeric",year:"numeric"})}function g({backdrop_path:t,genre_ids:e,overview:c,popularity:n,release_date:s,title:o,vote_average:r,vote_count:l}){return`
