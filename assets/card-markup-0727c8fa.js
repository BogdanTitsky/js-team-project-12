import{c as f,m as v}from"./footer-8f79c2c4.js";const $="/js-team-project-12/assets/comingSoon-22be8f72.jpg";async function b(e,o=100){const c=await f();return e.map(({poster_path:a,title:s,genre_ids:r,release_date:t,vote_average:l},m)=>{const g=a?`https://image.tmdb.org/t/p/w300${a}`:$,d=m>=o?"hide-mobile":"",n=r.slice(0,2).map(p=>c[p]).join(", "),i=t.substr(0,4);return`
