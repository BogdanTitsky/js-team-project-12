import"./footer-f29026e0.js";import{a as l,m as p}from"./card-markup-051f8f29.js";const r=document.querySelector(".js-upcoming");console.log(r);const m=document.querySelector("#upcoming-btn");async function u(){const t="https://api.themoviedb.org/3/movie/upcoming?api_key=183c3cacc9c38c09c14d38798ccfe9d7";return await l.get(t).then(({data:e})=>(console.log(e.results),e)).catch(e=>console.error(e))}u().then(({results:t})=>{const e=new Date,o=t.filter(s=>e<Date.parse(s.release_date));if(o.length===0){console.log("No");return}const c=Math.floor(Math.random()*o.length),i=_(o[c]);d(i),console.log(o[c]);const n="key";m.addEventListener("click",s=>{s.preventDefault(),localStorage.setItem(n,JSON.stringify(o[c]));const a=localStorage.getItem(n);console.log(a)})});function g(t){return new Date(t).toLocaleString("uk",{day:"numeric",month:"numeric",year:"numeric"})}function _({backdrop_path:t,genre_ids:e,overview:o,popularity:c,release_date:i,title:n,vote_average:s,vote_count:a}){return`
